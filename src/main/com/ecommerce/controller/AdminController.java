...
public class AdminController {
	...
	private UserService userService; 
	  ...
	  @RequestMapping(value = "/adminmembersearch", method = RequestMethod.POST)
	    public String memberssearch(ModelMap map, javax.servlet.http.HttpServletRequest request,
	    		@RequestParam(value="fname", required=true) String fname) 
	    {
		  ...
		  if(fname!=null)
		  {
			  List<User> list = userService.getUserByfname(fname);
			  map.addAttribute("list", list);
		  }
		  else
		  {
	  ...
	  @RequestMapping(value = "/purchaseFltByDate", method = RequestMethod.POST)
	    public String purchasesbydate(ModelMap map, javax.servlet.http.HttpServletRequest request,
	    		@RequestParam(value="purchasedate", required=true) String pdate) 
	    {
		  Date pdate_d = Date.valueOf(pdate);
		  // check if session is still alive
		  HttpSession session = request.getSession();;
		  if (session.getAttribute("admin_id") == null) {
			  return "admin/login";
		  ...
		  List<Purchase> list = purchaseService.getAllItemsByDate(pdate_d);
	  ...
	  @RequestMapping(value = "/purchaseFltByCategory", method = RequestMethod.POST)
	    public String purchasesbycategory(ModelMap map, javax.servlet.http.HttpServletRequest request,
	    		@RequestParam(value="category", required=true) String category) 
	    {
		  ...
		  List<Purchase> list = purchaseService.getAllItemsByCategory(category);
